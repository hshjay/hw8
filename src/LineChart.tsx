...
const LineChart: React.FC<Props> = ({ dataList, birthA, birthB }) => {
  // 사용자 A와 B 데이터 분리
  ...
  const options: ChartOptions<"line"> = {
    ...
    plugins: {
      legend: { position: "top" as const },
      title: { display: true, text: "출생 후 경과 일수별 키/몸무게 변화" },
    },
    scales: {
      x: {
